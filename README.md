...
- **BYOK 模式**：支持“自带能源”，你可以填入自己的api运行，不消耗公共额度。
- **双模切换**：支持在极速模式和逻辑模式之间自由切换。
...
- **V0.2.2**: 2026/4/8 修复了gemini旧版不兼容的问题，完成了v0.2中的数据库设计，小三月变得更聪明了。
- **V0.3**: 2026/4/21 增加了Grok-api，想和小三月聊点色色的也可以支持了，修改了部分代码结构，<del>不可以瑟瑟</del>
- *更多功能（如发送表情包、触发剧情）正在开发中。...* 📷
